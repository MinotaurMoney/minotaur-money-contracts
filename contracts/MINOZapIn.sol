...
///@author Zapper
///@notice This contract adds liquidity to VVS pools on Cronos using CRO or any ERC20 Tokens.
...
// File contracts/Avalanche/SushiSwap/SushiSwap_ZapIn_V1.sol
...
interface IMINOBondDepository {
    function deposit( uint _amount, uint _maxPrice, address _depositor) external returns ( uint );
}

contract MINO_ZapIn_V1 is ZapInBaseV3_1 {
    using SafeERC20 for IERC20;

    mapping (IMINOBondDepository => address) public allowedPairs;
    mapping (IMINOBondDepository => address) public allowedReserves;

    IUniswapV2Factory private constant sushiFactory =
        IUniswapV2Factory(0x3B44B2a187a7b3824131F8db5a74194D0a42Fc15);

    IUniswapV2Router02 private constant sushiRouter =
        IUniswapV2Router02(0x145863Eb42Cf62847A6Ca784e6416C1682b1b2Ae);

    address private constant wcroTokenAddress =
    ...
    constructor()
    {
        ...
        //allowedPairs
        //allowedPairs[IMINOBondDepository(0xc26850686ce755FFb8690EA156E5A6cf03DcBDE1)] = 0xf64e1c5B6E17031f5504481Ac8145F4c3eab4917;
        //allowedPairs[IMINOBondDepository(0xA184AE1A71EcAD20E822cB965b99c287590c4FFe)] = 0x113f413371fC4CC4C9d6416cf1DE9dFd7BF747Df;

        //allowedReserves
        //allowedReserves[IMINOBondDepository(0x694738E0A438d90487b4a549b201142c1a97B556)] = 0x130966628846BFd36ff31a822705796e8cb8C18D;
        //allowedReserves[IMINOBondDepository(0xE02B1AA2c4BE73093BE79d763fdFFC0E3cf67318)] = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    }
    ...
    function ZapInLp(
        ...
        IMINOBondDepository _bondDepository,
        uint256 _amount,
    ...
    function _uniDeposit(
        ...
        _approveToken(_ToUnipoolToken0, address(sushiRouter), token0Bought);
        _approveToken(_ToUnipoolToken1, address(sushiRouter), token1Bought);
    ...
    function _fillQuote(
        ...
        if (_swapTarget == wcroTokenAddress) {
            IWETH(wcroTokenAddress).deposit{ value: _amount }();
            return _amount;
        }
    ...
    function _fillQuoteLp(
        ...
        if (_swapTarget == wcroTokenAddress) {
            IWETH(wcroTokenAddress).deposit{ value: _amount }();
            return (_amount, wcroTokenAddress);
        }
